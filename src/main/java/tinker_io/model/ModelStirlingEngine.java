...
public class ModelStirlingEngine extends ModelBase {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        this.setOffset(plateModelWraper, 0, (float)getSinFrequency(-0.18f, 0f, angle), 0);
        this.setOffset(poolModelWraper, 0, (float)getSinFrequency(-0.1f, 0.18f, angle), 0);
        ...
        //1point = 0.063 offset
        this.setRotateAngle(wheelModelWraper, (float) angle, 0, 0);
